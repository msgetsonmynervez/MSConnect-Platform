    ...
    return (
      <div style={styles.container}>
        <div style={{ ...styles.card, textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: '22px', color: '#1C2B3A', marginBottom: '12px', fontFamily: 'Georgia, serif' }}>
            Email sent</h2>
          <p style={{ color: '#6B7280', fontSize: '14px', lineHeight: 1.6, marginBottom: '28px' }}>
            If an account exists for <strong style={{ color: '#1C2B3A' }}>{email}</strong>,
            you'll receive a reset link shortly.</p>
          <Link to="/signin" style={{ ...styles.button, display: 'block', textDecoration: 'none' }}>
        ...
        <div style={styles.form}>
          <div style={styles.field}>
            ...
            <input style={styles.input} type="email" placeholder="you@example.com"
              ...
              onKeyDown={e => e.key === 'Enter' && handleReset()} autoCapitalize="none" />
          </div>
